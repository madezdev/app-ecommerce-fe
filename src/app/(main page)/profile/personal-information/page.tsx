...
export default function PersonalInformationPage () {
  const cuit = useInput('20304962047')
  const userId = useInput('30406204')
  const birthdate = useInput('1993-06-04')
  ...
  return (
    <div className='max-w-[1000px] mx-auto px-4 md:px-0 mt-[160px] flex flex-col min-h-[calc(100vh-160px)]'>
