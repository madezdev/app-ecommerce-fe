          ...
          <ul className="mt-10 flex flex-col gap-3">
            {
              itemsMenu.map((item, index) => (
                <li
                  key={ index }
                  className=" flex items-center gap-2 hover:bg-pyellow/50 p-1 rounded transition-all delay-50 cursor-pointer hover:shadow-md active:shadow-none active:scale-95"
                >
                  { item.icon }
